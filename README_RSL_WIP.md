...
### 0. Get API Keys for OpenAI and LiteralAI (Chainlit)

#### - Get OpenAI API Key

1. Go to your OpenAI account and get or create an API key.
...
#### - Get LiteralAI API Key

***Go to this webpage: ***

1. https://cloud.getliteral.ai/projects/
2. Go to "Settings" gear icon at the lower left-hand corner.
3. If you don't have a key, it will prompt you to create your own project 
4. Create a project.  
5. Copy the API key and save it locally as an object named "LITERAL_API_KEY". 
6. Add your LITERAL_API_KEY to the .env file.
7. Run the demo application to test that everything is set up correctly.
